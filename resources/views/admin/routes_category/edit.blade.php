          ...
          <div class="section-body">
                ...
                <div class="card">
                  <div class="card-header">
                    <h4>Edit Route Category
                    <span style="float:right"><a href="{{ route('admin.route-category.index') }}" class="btn btn-primary">Back to list</a></span>
                    </h4>
                  </div>
                  <div class="card-body">
                    <form enctype="multipart/form-data" method="post" action="{{ route('admin.route-category.update' , $categoryDetails->id) }}">{{csrf_field()}} @method('put')
                      ...
                      <div class="row col-md-6 offset-md-3">
                        ...
                        <div class="controls">
                          <input type="text" name="name" id="category_name"  class="form-control" value="{{ $categoryDetails->name }}" required>
                          @error('name')
                              <span class="invalid-feedback" role="alert">
                                  <strong>{{ $message }}</strong>
                              </span>
