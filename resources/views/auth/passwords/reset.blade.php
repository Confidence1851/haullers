            ...
            <div class="row">
                ...
                <div class="col-md-6 form__box--item form__box--item--1">
                    <div class="form__logo">
                        ...
                        <p>Fill in your desired password to <b style="color: #e41111">reset password!</b></p><br>
                    </div>
                     <br>
                    ...
                    @endif
                      <form method="POST" action="{{ route('password.update') }}">
                        ...
                        <div class="form__input--container form__login__input--container mt-3">
                            <input type="email" placeholder="Email address" id="email" name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus
                          ...
                          <div class="form__input--container form__login__input--container">
                            <input type="password" placeholder="New Password" id="password" name="password"  required autofocus
                                class="form__input form__login__input" />
                            <label for="password" class="form__input--label">New Password</label>
                             @error('password')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                          ...
                          <div class="form__input--container form__login__input--container">
                            <input type="password" placeholder="Confirm Password" id="password_confirmation" name="password_confirmation" required autofocus
                                class="form__input form__login__input" />
                            <label for="email" class="form__input--label">Confirm Password</label>
                         </div>
                        
                        <input type="submit" value="Reset Password" class="form__btn" />
                        <br><br>
                    </form>
                </div>
            </div>
