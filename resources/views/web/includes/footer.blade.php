             ...
             <div class="row">
                 ...
                 <div class="col-lg-4">
                     <div class="footer__content">
                         ...
                         <p class="footer__paragraph--active"><span> <a href="https://facebook.com/haullersonline" target="_blank"> <i class="fal fa-mobile"></i>  facebook.com/haullersonline   </a>  </span></p>
                         <p class="footer__paragraph--active"><span> <a href="https://instagram.com/haullersonline" target="_blank"> <i class="fal fa-mobile"></i>  instagram.com/haullersonline  </a>   </span></p>
                         <p class="footer__paragraph--active"><span> <a href="https://twitter.com/haullersonline" target="_blank"> <i class="fal fa-mobile"></i>  twitter.com/haullersonline   </a>  </span></p>
                         <p class="footer__paragraph--active"><span> <a href="https://linkedIn.com/haullersonline" target="_blank"> <i class="fal fa-mobile"></i>  linkedIn.com/haullersonline   </a>  </span></p>
                     </div>
                 </div>
                 <div class="col-lg-4">
                     <div class="footer__content">
                         ...
                         <p class="footer__paragraph--active"><span> <a href="tel:+234-8123282500"> <i class="fal fa-mobile"></i> +234-8123282500  </a> </span>
                         </p>
                         <p class="footer__paragraph--active"><span><i class="fal fa-envelope"></i><a href="mailto:info@haullersonline.com" style="color:#CECBCE"> info@haullersonline.com</a></span></p>
                     </div>
                 </div>
             </div>
         </div>
          <div class="footer__copyright">
             <p>Copyright <i class="fal fa-copyright"></i> 2019 All rights reserved</p>
         </div>
      </footer>   
         <!-- Script for boostrap -->
