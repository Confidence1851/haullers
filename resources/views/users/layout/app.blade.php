...
<head>
    ...
    <title>Haullers User Dashboard</title>
                ...
                <div class="menu-inner">
                    <nav>
                        <ul class="metismenu" id="menu">
                            ...
                            <li class="">
                                <a href="{{ url('/users/orders/view') }}"><i class="ti-receipt"></i><span>My Orders</span></a>
                            </li>
                            
                            <li class="">
                                <a href="{{ url('/users/payments/view') }}"><i class="ti-credit-card"></i><span>My Payments</span></a>
                            </li>
